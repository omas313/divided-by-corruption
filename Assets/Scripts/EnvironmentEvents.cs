...
public class EnvironmentEvents
{
    ...
    public static Action<RoomAttendant> PlayerEnteredRoom;
    public static Action<RoomAttendant> PlayerExitedRoom;
    ...
    public static void InvokePlayerEnteredRoom(RoomAttendant roomAttendant) => PlayerEnteredRoom?.Invoke(roomAttendant);
    public static void InvokePlayerExitedRoom(RoomAttendant roomAttendant) => PlayerExitedRoom?.Invoke(roomAttendant);
